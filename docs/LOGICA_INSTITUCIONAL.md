...
## 3. Gestión de Personas (Autores de Proyectos)
- **Sincronización Automática**: Cualquier Director o integrante de Equipo Técnico ingresado manualmente que no exista en el registro, se guarda automáticamente en la colección `staff`.
- **Buscador Inteligente**: Los campos de personas incluyen un componente de autocompletado que busca por Apellido en el registro de autores en tiempo real.
