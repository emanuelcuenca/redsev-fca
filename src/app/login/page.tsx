        ...
        <Card className="border-none shadow-2xl bg-white/80 backdrop-blur-sm rounded-3xl overflow-hidden">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#" className="text-xs text-primary font-bold hover:underline">¿Olvidó su contraseña?</Link>
                </div>
                <div className="relative group">
              ...
              >
                {loading ? (
                  ...
                  <span className="flex items-center gap-2">Iniciar Sesión <ArrowRight className="w-5 h-5" /></span>
                )}
              </Button>
            </form>
          </CardContent>
          <CardFooter className="bg-muted/50 p-6 flex justify-center border-t border-muted">
            <p className="text-sm text-muted-foreground">
              Solo personal autorizado. <Link href="#" className="text-primary font-bold hover:underline">Solicitar acceso</Link>
            </p>
          </CardFooter>
        </Card>
      </div>
